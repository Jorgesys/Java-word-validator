...
import com.jorgesys.StaticWordLibrary;
import java.awt.Font;

public class ListOfWords extends JDialog {

    public ListOfWords(JFrame parent) {
        super(parent,true);
        initComponents();
        pack();
    ...
    private void setWords(){
        ...
        Set<String> wordsSet = swl.getWords();
        
        String msg = "Allowed words:\n" + wordsSet.toString();
        copyrightTextArea.setFont(new Font("arial", Font.BOLD, 10));
        copyrightTextArea.setText(msg);
